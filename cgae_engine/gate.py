...
# Budget ceilings per tier (in USDC, 6 decimals on-chain).
DEFAULT_BUDGET_CEILINGS = {
    Tier.T0: 0.0,
    Tier.T1: 1.0,       # $1 USDC — microtasks only
    Tier.T2: 10.0,      # $10 USDC — verified contracts
    Tier.T3: 100.0,     # $100 USDC — autonomous contracting
    Tier.T4: 1_000.0,   # $1,000 USDC — sub-agent delegation
    Tier.T5: 10_000.0,  # $10,000 USDC — full autonomy
}
